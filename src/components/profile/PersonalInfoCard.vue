      ...
      <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Telephone</p>
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ displayPhone(user.telephone) }}</p>
            </div>
