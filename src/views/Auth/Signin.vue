          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              ...
              <div>
                ...
                <Alert variant="destructive" v-if="mety">
                  <KeyRoundIcon/>
                ...
                <form @submit.prevent="handleSubmit" class="p-2">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <div class="relative">
                        <input required v-model="password" :type="showPassword ? 'text' : 'password'" id="password"
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <router-link to="/reset-password"
                        class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">Mot 
                        de passe oublier?</router-link>
                    </div>
                    <!-- Button -->
                    <div>
                      <button type="submit" 
                        class="flex items-center justify-center w-full h-11 px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                        Se connecter
                      </button>
                    </div>
                  </div>
        ...
        <div class="relative items-center hidden w-full h-full lg:w-1/2 bg-brand-950 dark:bg-white/5 lg:grid">
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center font-black text-7xl text-blue-400 dark:text-white/60">
             HM
              </p>
            </div>
          </div>
