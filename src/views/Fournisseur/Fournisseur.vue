        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 md:gap-4">
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div class="w-full">
                        <span class="text-lg font-bold text-gray-500 dark:text-gray-400">Nouveau fournisseur</span>

                        <Input class="mt-2 h-11" v-model="fournisseurName" placeholder="Nom du fournisseur"></Input>
                        <Button :onClick="createfournisseur"
...
const currentPageTitle = ref("Fournisseur");
const openAlert = ref(false);

const fournisseurName = ref("");
...
const createfournisseur = async () => {
    try {
        const response = await api.post("api/fournisseur/create", {
            name: fournisseurName.value,
        });
        ...
        message.value = error.response?.data?.message || "Une erreur est survenue lors de la création du fournisseur.";
